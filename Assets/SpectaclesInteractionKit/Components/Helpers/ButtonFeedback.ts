...
export class ButtonFeedback extends BaseScriptComponent {
  ...
  public get defaultIcon(): Texture | undefined {
    return this._defaultIcon;
  }
  public set defaultIcon(value: Texture | undefined) {
    this._defaultIcon = value;

    print("Setting default icon to: ");
  ...
  private init = (): void => {
    print("Initializing ButtonFeedback component...");
